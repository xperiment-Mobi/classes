package com.bulkloader.lazyloaders{
    import flash.events.*;
    import flash.net.*;
     ...
     *
     *  @eventType com.bulkloader.BulkProgressEvent.PROGRESS
     */
    [Event(name="lazyComplete", type="flash.events.Event")];
    /** A serialized version of a BulkLoader instance. This class allows you to keep external  files with a complete description of what loading items should be loaded. This class is not meant to be used directly, but used as a base classes for specific data transports (xml, json).
     *   
     */
